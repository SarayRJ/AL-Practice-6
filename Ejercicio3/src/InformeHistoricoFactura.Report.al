report 70952 InformeHistoricoFactura
{
    ...
    DefaultRenderingLayout = "PersonalizedSalesInvoice.rdl";
    ...
    rendering
    {
        layout("PersonalizedSalesInvoice.rdl")
        {
            Type = RDLC;
            LayoutFile = './src/PersonalizedSalesInvoice.rdl';
